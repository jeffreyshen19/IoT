...
public class SSLSimpleClient {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      System.out.println("\033[1m\033[32mSuccessfully connected to secure server\033[1m");
      pw.flush();
      br.readLine();
      ...
      while(true){
        ...
        if(serverResponse.indexOf("SCALE=") != -1){
          ...
          if(!running) System.out.println("\033[1m\033[32mStarted monitoring sensors\033[1m");
          running = true;
        }
        else if(serverResponse.equals("STOP")){
          if(running) System.out.println("\033[1m\033[31mStopped monitoring sensors\033[1m");
          running = false;
        }
